...
public class FileServiceImpl implements FileService {
  ...
  public Map<String, Object> ckeditorUpload(MultipartFile upload, String contextPath) {
    ...
    // CKEditor로 저장된 이미지를 확인할 수 있는 경로를 {url: http:// localhost:8080/...} 방식으로 반환해야 함
    return Map.of("url", contextPath +  path + "/" + filesystemName
                 , "uploaded", true);
    
    /*
     *  CKEditor로 반환할 url 
     *    http://localhost:8080/app13/storage/2023/10/18/80be9a7d38fd4b96bcef4902d124b023.jpg
     *    
     *  servlet-cotnext.xml에
