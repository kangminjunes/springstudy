...
@RequiredArgsConstructor // 생성자 주입(@Autowired)을 통해서 final  private final MemberDao memberDao; 에 Bean을 주입한다.
@Service
public class MemberServiceImpl implements MemberService {

  private final MemberDao memberDao;
  
  //@RequiredArgsConstructor와 동일한 코드는 아래와 같다. 같은 기능 수행한다.
  /*
  @Autowired
  public MemberServiceImpl(MemberDao memberDao) {
    super();
    this.memberDao = member Da0;
  }
   */
