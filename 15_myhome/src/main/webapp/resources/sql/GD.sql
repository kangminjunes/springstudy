...
-- 자유게시판(계층형-1차, 댓글/대댓글 작성 가능)
CREATE TABLE FREE_T (
    FREE_NO     NUMBER             NOT NULL,
    EMAIL       VARCHAR2(100 BYTE)  NULL,
    CONTENTS    VARCHAR2(4000 BYTE) NOT NULL,
    CREATED_AT  TIMESTAMP           NULL,
    STATUS      NUMBER              NOT NULL,   -- 1:정상 게시글, 0:삭제된 게시글(실제로 삭제되지 않는 게시판)
    DEPTH       NUMBER              NOT NULL,   -- 0:원글 1:댓글 2:대댓글 .... N:대대대대대대...댓글    
    GROUP_NO    NUMBER              NOT NULL,   -- 원글과 모든 댓글(댓글,대댓글)은 동일한 GROPU_NO를 가져야 함.
...
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용1', SYSTIMESTAMP, 1, 0, FREE_sEQU.CURRVAL, 0);
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용1', SYSTIMESTAMP, 1, 0, FREE_sEQU.CURRVAL, 0);
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용1', SYSTIMESTAMP, 1, 0, FREE_sEQU.CURRVAL, 0);
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용1', SYSTIMESTAMP, 1, 0, FREE_sEQU.CURRVAL, 0);
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용1', SYSTIMESTAMP, 1, 0, FREE_sEQU.CURRVAL, 0);
